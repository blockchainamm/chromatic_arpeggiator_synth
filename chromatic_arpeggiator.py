# Program to simulate a chromatic scale arpeggiator matching the frequencies of notes in piano
...
def load_notes(notestep):
    ...
    # Interval of notes for a chromatic scale
    notes_interval = [1, 1, 1, 1] 
    
    tones_fwd = []
    
    print(f'The frequencies in Hz of ascending notes of the chromatic scale arpeggiator for note {notescale}')
    for note in notes_interval: 
        # print the frequency ascending notes of the chromatic scale       
    ...
    # Return list of frequencies in the ascending notes of the chromatic scale  
    return tones_fwd
...
def fmain(tones_fwd):
    ...
    # Loop arpeggio sequence 10 times non stop to produce chromatic scale arpeggiator effect
    while nbr <= arp_cycl:
...
# Note list to produce chromatic scale arpeggiator pattern sequence
scale_list = ['C4']#, 'G4', 'A4', 'F4'] 
#scale_list = ['C4', 'G4', 'A4', 'F4'] 
